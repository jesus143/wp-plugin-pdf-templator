 ...
 */
define ('K_PATH_MAIN', '/homepages/33/d150163012/htdocs/Passport Pro/wp-content/plugins/pdf-templator/tcpdf/');

/**
 * URL path to tcpdf installation folder (http://localhost/tcpdf/).
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_URL', 'http://www.britishpassportservices.co.uk/wp-content/plugins/pdf-templator/tcpdf/');
 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', dirname(__FILE__).'/tcpdf/examples/images/');
