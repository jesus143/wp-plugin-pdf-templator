...
$this->header_line_spacing = 0.1;	// spacing between bottom of header and line (if present) - function of fontsize
$this->footer_line_spacing = 0.1;	// spacing between bottom of header and line (if present) - function of fontsize
